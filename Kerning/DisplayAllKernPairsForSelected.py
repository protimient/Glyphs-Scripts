# MenuTitle: Display All Kern Pairs For Selected
# -*- coding: utf-8 -*-
__doc__ = """
Opens a tab containing all the kern pairs in the font for the currently selected glyphs.
"""
...
selected_glyph_names = [sl.parent.name for sl in Glyphs.font.selectedLayers]
...
for left_gs, rights_gs in Glyphs.font.kerning[selected_master_id].items():
    ...
    for right_gs, val in rights_gs.items():
        ...
        if left_display_name in selected_glyph_names or right_display_name in selected_glyph_names:
